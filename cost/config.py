...
class CostConfig:
    TIER_LIMITS: Dict[str, float] = field(default_factory=lambda: {
    ...
    CONFIRMATION_THRESHOLD: float = float(os.getenv("COST_CONFIRMATION_THRESHOLD", "0.7"))

    MIN_CONFIDENCE_BASE: float = float(os.getenv("COST_MIN_CONFIDENCE_BASE", "0.75"))

    BENCHMARKS: Dict[str, int] = field(default_factory=lambda: {
